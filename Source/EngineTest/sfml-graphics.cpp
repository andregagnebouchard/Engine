...
TEST(DISABLED_SFMLGraphics, SFMLGraphics)
{
	...
	while (!exit)
	{
		...
		if (!backgroundTexture.loadFromFile("../../Support/Testing/sfmlGraphicsTest/background.jpg"))
			FAIL();
		sf::Sprite background(backgroundTexture);

		// Create some text to draw on top of our OpenGL object
		sf::Font font;
		if (!font.loadFromFile("../../Support/Testing/sfmlGraphicsTest/sansation.ttf"))
			FAIL();
		...
		sf::Texture texture;
		if (!texture.loadFromFile("../../Support/Testing/sfmlGraphicsTest/texture.jpg"))
			FAIL();
