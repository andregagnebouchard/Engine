...
namespace Game
{
	...
	void CollisionLogicComponent::OnCollision(shared_ptr<Event> event)
	{
		...
		if (type1 == Entity::Type::SmallDot && type2 == Entity::Type::Pacman)
			OnCollisionPacmanSmallDot(collisionEvent->GetEntityId2(), collisionEvent->GetEntityId1());
		if (type1 == Entity::Type::Pacman && type2 == Entity::Type::SmallDot)
			OnCollisionPacmanSmallDot(collisionEvent->GetEntityId1(), collisionEvent->GetEntityId2());
	}
